      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/" element={<Layout />}>
            ...
            <Route path="my-cards" element={<Navigate to="/overview" replace />} />
            <Route path="stats" element={<Navigate to="/overview" replace />} />
            <Route path="top-employees" element={<Navigate to="/overview" replace />} />
